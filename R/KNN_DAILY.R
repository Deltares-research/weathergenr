...
#' @return
#' @export
KNN_DAILY <- function(cur_sim_PRCP, cur_sim_TEMP, PRCP_TODAY, TEMP_TODAY, DATE_TOMORROW, k, sd_monthly_PRCP,
	  ...
	  w_PRCP <- 100/sd_monthly_PRCP
		...
		#K_Distances <- matrix(cbind(var_order,distance)[order(distance),],ncol=2)[1:k,1]
