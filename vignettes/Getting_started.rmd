...
Lets look at annual series and monthly variation of daily variables:
```{r ncdata5, fig.height = 5, fig.width = 7}
...
```{r stochastic2, results='hide', eval = FALSE, cache=TRUE}
...
```{r stochastic3, eval = FALSE, cache=TRUE}
# Resampled dates
