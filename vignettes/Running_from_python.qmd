...
This vignette demonstrates how to run the **weathergenr** R package from a
**Python** environment using **rpy2**. The workflow is designed to be portable
across machines and operating systems and avoids hard-coded, user-specific
paths.
...
Install the latest version of R from CRAN and verify that it is available
...
Avoid setting `PYTHONHOME` and `PYTHONPATH` unless debugging a misconfigured
environment.
