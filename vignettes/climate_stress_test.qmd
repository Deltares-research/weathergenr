---
title: "Climate Stress Testing with weathergenr"
description: "Design climate stress-test scenarios, apply monthly perturbations to stochastic weather, and validate precipitation changes."
format:
  html:
    toc: true
    toc-location: right
...
execute:
  ...
  execute-dir: project
vignette: >
  %\VignetteIndexEntry{Climate stress testing}
...
ggplot(temp_ts_long, aes(x = Day, y = Temperature, color = Series)) +
  ...
  labs(
    ...
    subtitle = paste0("First ", n_plot, " days: +2 deg C shift"),
