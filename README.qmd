...
Synthetic series can be modified using **quantile-based perturbation methods** (quantile mapping–style transformations), enabling scenario-consistent changes (e.g., temperature shifts, precipitation scaling) while keeping stochastic variability and imposed trends separable.
