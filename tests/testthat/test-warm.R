...
# - R/wavelet_warm.R: simulate_warm() and its ARMA / bootstrap / variance-matching
#   internals.
#
# The CWT and plotting functions are covered by test-wavelet.R. They used to be
# duplicated here against the since-removed R/wavelet.R; those copies were older
# and in two cases weaker, so they were dropped rather than merged.
